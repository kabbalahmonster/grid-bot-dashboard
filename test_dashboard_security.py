...
class TestStatusPayloadAllowlist(unittest.TestCase):
    def test_drops_unknown_top_level_and_nested_fields(self):
        payload = {
            ...
            "positions": [{
                "id": "1", "pnl": 5.0, "executable_pnl": -7.25,
                "executable_net_return_eth": 0.00275,
                "executable_projected_gas_eth": 0.00005,
                "executable_quote_provider": "uniswap",
                "executable_quote_settlement": "native",
                "executable_quote_basis": "exact_reverse_quote",
                "executable_quote_at": "2026-09-15T12:00:00+00:00",
                "executable_sell_amount_raw": "123456",
                "private_note": "nope",
            }],
