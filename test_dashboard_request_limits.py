...
class TestDashboardRequestLimits(unittest.TestCase):
    ...
    def test_realized_profit_summary_cycles_units(self):
        ...
        for label in ("All", "Month", "Week", "5 day", "3 day", "24 hr", "12 hr", "6 hr", "4 hr", "2 hr", "1 hr"):
        ...
        self.assertIn("'5d': 'Since 5d ago'", body)
    ...
    def test_sell_checks_summary_lists_and_focuses_running_bots(self):
        ...
        self.assertIn("const activeTournaments = Object.keys(bots).flatMap", body)
        self.assertIn("tournamentForDisplay(state.buy_attempt?.route_comparison, botKey)", body)
        self.assertIn("tournamentForDisplay(state.sell_attempt?.route_comparison, botKey)", body)
        self.assertIn("return confirmed || active", body)
    ...
    def test_sell_check_displays_projected_net_profit_after_gas(self):
        ...
        self.assertIn("Projected profit after sell gas / minimum profit", body)
        self.assertNotIn("ETH net</span>", body)
